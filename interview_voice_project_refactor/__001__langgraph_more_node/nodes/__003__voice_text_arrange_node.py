...
async def voice_text_arrange_node(state: AgentState):
    ...
    - 采用流式输出
    """
    await update_mysql("开始整理语音文本", record_id=state["record_id"], processing_status=1)
